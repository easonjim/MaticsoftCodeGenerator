...
namespace Maticsoft.BuilderDALParam
{
    ...
    public class BuilderDAL : Maticsoft.IBuilder.IBuilderDAL
    {
        ...
        public string CreatUpdate2()
        {
            ...
            strclass.AppendSpaceLine(2, "/// <summary>");
            strclass.AppendSpaceLine(2, "/// " + "批量更新数据");
            strclass.AppendSpaceLine(2, "/// " + "注意：参数要使用防SQL注入过滤");
            strclass.AppendSpaceLine(2, "/// </summary>");
        ...
        public string CreatAddOrUpdate()
        {
            ...
            if (Keys.Count > 0)
            {
                ...
                if (!string.IsNullOrEmpty(strInparam))
                {
                    ...
                    switch (strretu1) //这里只要两个类型
                    {
                        case "int":
                        case "long":
                            strclass.AppendSpaceLine(4, "if (this.Add(model)>0)//改为这个更加智能");
                            break;
                        default:
                            strclass.AppendSpaceLine(4, "if (this.Add(model))//改为这个更加智能");
                            break;
                    }
